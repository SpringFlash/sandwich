class ProductCard extends Events {
  ...
  constructor(product, market, numb) {
    super(ProductCard.events); // event names
  ...
  render() {
    const clone = document
      .getElementById("templ_prod_card")
    ...
    clone
      .querySelector(".product_card_description")
      .append(this.counter.render(this.id));
    clone
      .querySelector(".product_card_btn")
      .addEventListener("click", () => this.emit("buy", this));
